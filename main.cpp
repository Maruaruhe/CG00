...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
	...
	//三角形描画
	mainRoop->graphicsRenderer1->Draw(&LeftBottom1, &MiddleTop1, &RightBottom1, mainRoop->directX12);
	mainRoop->graphicsRenderer2->Draw(&LeftBottom2, &MiddleTop2, &RightBottom2, mainRoop->directX12);
